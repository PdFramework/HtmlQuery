namespace PeinearyDevelopment.Framework.HtmlQuery.Tests.Unit
{
    ...
    public class HtmlParserTests
    {
        ...
        public void TextOnlyElement()
        {
            ...
            Assert.IsFalse(element.Descendants.Any());
        ...
        //    Assert.IsFalse(html.Descendants.First().Descendants.Any());
        ...
        //    Assert.AreEqual(12, head.Descendants.Count());
        ...
        public void GetSpecialTag()
        {
            ...
            Assert.IsFalse(scriptElement.Descendants.Any());
